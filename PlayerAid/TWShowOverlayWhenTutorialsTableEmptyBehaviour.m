...
#import "TWShowOverlayWhenTutorialsTableEmptyBehaviour.h"
#import "TutorialsTableDataSource.h"


@interface TWShowOverlayWhenTutorialsTableEmptyBehaviour ()
...
@implementation TWShowOverlayWhenTutorialsTableEmptyBehaviour
...
- (void)updateTableViewScrollingAndOverlayViewVisibility
{
  ...
  if (self.dataSource.totalElementsCount == 0) {
