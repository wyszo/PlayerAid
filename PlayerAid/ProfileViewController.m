...
- (void)setupTutorialsTableDataSource
{
  ...
  self.tutorialsTableDataSource.predicate = [NSPredicate predicateWithFormat:@"flaggedAsInappropriate == 0 AND createdBy = %@ AND state != %@", self.user, kTutorialStateUnsaved];
