...
/**
 Call that from awakeFromNib or viewDidLoad if you're using storyboards
 */
- (void)setupWithMainImage:(UIImage *)image tableScrollingType:(MGSpotyViewTableScrollingType)scrollingType;
