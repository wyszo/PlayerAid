...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MGSpotyViewController/MGSpotyViewController.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/NSString+RemoveEmoji/NSString_RemoveEmoji.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TWCommonLib/TWCommonLib.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/XRSA/XRSA.framework"
  install_framework "$BUILT_PRODUCTS_DIR/YCameraView/YCameraView.framework"
fi
