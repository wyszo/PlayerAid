...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "YCameraView/YCameraViewController/UI/ic-camera.png"
  install_resource "YCameraView/YCameraViewController/UI/ic-camera@2x.png"
  install_resource "YCameraView/YCameraViewController/UI/ic-camera@3x.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.flash.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.flash@2x.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.flash@3x.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.grid.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.grid@2x.png"
  install_resource "YCameraView/YCameraViewController/UI/ic.grid@3x.png"
